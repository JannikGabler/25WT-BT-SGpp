...
// %include "combigrid/src/sgpp/combigrid/basis/HeterogeneousBasis.hpp"
    ...
    // namespace std {
    //   %template(BasisVector) vector<sgpp::base::Basis<sgpp::combigrid::level_t,
    //   sgpp::combigrid::index_t>*>; %template(FullGridVector) vector<sgpp::combigrid::FullGrid>;
