...
TensorGrid::TensorGrid(const MI<size_t>& nGPPerDim)
    : nGPPerDim(nGPPerDim),
      gridPoints(nGPPerDim.productofElems(), base::DataVector(nGPPerDim.size())) {}

TensorGrid::TensorGrid(const MI<size_t>& nGPPerDim, const std::vector<base::DataVector>& gridPoints)
...
const base::DataVector& TensorGrid::getGridPoint(const MI<size_t>& mi) const {
...
void TensorGrid::setGridPoint(const MI<size_t>& mi, base::DataVector gp) {
