...
/**
 * @file multiindex_vector_downwards_closure_test.cpp
 * @brief Boost.Test cases for the downwards-closure construction
 * (@c MIVec::downwardsClosure / @c tools::genMIVecDownwardsClosure).
 */
